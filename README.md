...
[![My Skills](https://skillicons.dev/icons?i=c,java,python,javascript,dotnet,nodejs,npm,vite,react,expressjs,html,css,tailwindcss,qt,mysql,postgresql,firebase,mongodb,git&perline=18)](https://skillicons.dev)
